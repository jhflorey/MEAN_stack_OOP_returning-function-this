// One of the tricks to being an efficient coder is being able to rapidly change the code that is no longer working
...
function GameConstructor(consumerPrice,dealerCost,name, inStock){
	...
	function myPrivateFunction(){
		cosnole.log('hello, I am going to create a new object when I am returned!');
	}
...
// *********************************************************************************
// we can organize to something like below, a pattern that we can reuse:
